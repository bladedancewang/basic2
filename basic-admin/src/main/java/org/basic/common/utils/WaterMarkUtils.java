...
public class WaterMarkUtils {
    ...
    public static void main(String[] args) {
        Font font = new Font("微软雅黑", Font.PLAIN, 55);                     //水印字体
        String srcImgPath="E:/268698067018874646.jpg"; //源图片地址
        String tarImgPath="E:/t.jpg"; //待存储的地址
        String waterMarkContent="需截图";  //水印内容
